        ...
        this.renderField = function (field) {
            ...
            fieldProps.className =
                typeof fieldProps.className === "function"
                    ...
                    : fieldProps.className;
            // render the control
            return (React.createElement(Control, __assign({ key: name }, fieldProps, { value: values[name], onBlur: field.handleBlur, onChange: field.handleChange })));
        };
        // create a form
        this.createForm = function () {
            return function (props) {
                var fields = props.fields, name = props.name, className = props.className, formik = __rest(props, ["fields", "name", "className"]);
                return (React.createElement(Formik, __assign({}, formik), function (formConfig) { return (React.createElement(Form, { name: name, className: className }, fields.map(function (field) {
